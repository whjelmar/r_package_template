...
find . -path ./.git -prune -o -type f -exec sed -i "s/rolemapr/$package_name/g" {} +
find . -path ./.git -prune -o -type f -exec sed -i "s/A package to produce roles and responsibility maps/$package_title/g" {} +
